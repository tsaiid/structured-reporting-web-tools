...
$( document ).ready(function() {
    ...
    $('#ajccModalLongTitle').html("AJCC Definitions for Hypopharyngeal Cancer <span class='badge badge-secondary ml-2' style='font-size: 60%; vertical-align: super;'>8th</span>");
