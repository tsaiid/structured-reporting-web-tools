...
if (process.env.NODE_ENV !== 'production') {
    require('../html/ajcc/prostate.html?raw');
}
...
setupReportPage({
    ...
    ajccTitleHtml: "AJCC Definitions for Prostate Carcinoma <span class='badge badge-secondary ml-2' style='font-size: 60%; vertical-align: super;'>8th</span>"
});
