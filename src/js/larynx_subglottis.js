...
if (process.env.NODE_ENV !== 'production') {
    require('raw-loader!../html/ajcc/larynx_subglottis.html');
}
...
$( document ).ready(function() {
    ...
    $('#ajccModalLongTitle').html("AJCC Definitions for Laryngeal Carcinoma (Subglottis) <span class='badge badge-secondary ml-2' style='font-size: 60%; vertical-align: super;'>8th</span>");
