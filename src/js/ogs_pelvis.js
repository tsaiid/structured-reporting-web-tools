...
if (process.env.NODE_ENV !== 'production') {
    require('../html/ajcc/ogs_pelvis.html?raw');
}
...
setupReportPage({
    ...
    ajccTitleHtml: "AJCC Definitions for OGS of Pelvis <span class='inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-gray-200 text-gray-800 dark:bg-gray-700 dark:text-gray-300 ml-2' style='vertical-align: super;'>8th</span>"
});
