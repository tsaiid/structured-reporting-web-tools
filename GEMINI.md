...
* **Format**: The generated text should be clean, without HTML tags (plain text), unless rich text is specifically requested.
    * *Example*: `Lung-RADS Category: 4A (Suspicious)`
...
---
*Note to AI: The user is an experienced Radiologist and hobbyist developer. Prioritize medical correctness and workflow efficiency (fewer clicks).*